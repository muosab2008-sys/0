	...
	<div class="col-lg-12">
	  <div class="card">
		<div class="card-body p-2">
			...
			<hr class="global">
			<h2 class="">6) Anticheat &amp; Account Suspension</h2>
			<ol>
