        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          <li class="nav-item navbar-dropdown dropdown me-2">
            <a style="border-radius: var(--bs-border-radius)"
              ...
              <span class="d-flex align-items-center f-md" x-data="{ balance: '2783960' }"
                x-on:update-balance.window="balance = $event.detail.balance;">

                <img src="/assets/img/coin.png" alt="" width="10" class="me-1"
                  x-show="is_coin == '1'">
                <i class="fa-solid fa-dollar-sign me-1" x-show="is_coin == '0'" style="display: none;"></i>
                <span><?php echo number_format($data['account_balance'], 2); ?></span>
                <svg width="20px" class="ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
          ...
          <?php if($data['admin'] == 1) { ?>
            <a href="<?=GenerateURL('dashboard', false, true)?>" target="_blank" class="mt-1">
